import cv2
import time
from object_detector_yolo import detect_objects
...
while True:
    ...
    result = detect_objects(frame, '/home/rodri/Documents/Weapon_detection/ai/models/YoloV5_150_epochs.pt', device='cpu', conf_threshold=0.6)
