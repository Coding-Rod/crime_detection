# Crime Detection guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `crime_detection/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `crime_detection` folder and use the modules inside your notebooks :
...
```python
from crime_detection.utils.paths import data_dir
data_dir()
```
